...
namespace DS.Motel.Clients.Web.Areas.AddressBook.Controllers
{
    public class ParametrosController : Controller
    {
        ...
        private List<Tuple<string, string>> GetErroresAdd(AddViewModel model)
        {
            ...
            {
                toReturn.Add(new Tuple<string, string>("Tiempo_Hora", "Por favor ingrese una cantidad en minutos"));
            }
            if (model.Tiempo_Incremento == null)
            {
                toReturn.Add(new Tuple<string, string>("Tiempo_Incremento", "Por favor ingrese una cantidad en minutos"));
            }
            ...
            {
                toReturn.Add(new Tuple<string, string>("Tolerancia", "Por favor ingrese una cantidad en minutos"));
            }
            if (model.Tiempo_Anular == null)
            {
                toReturn.Add(new Tuple<string, string>("Tiempo_Anular", "Por favor ingrese una cantidad en minutos"));
            }
            if (model.Tiempo_Salir == null)
            {
                toReturn.Add(new Tuple<string, string>("Tiempo_Salir", "Por favor ingrese una cantidad en minutos"));
            }
            if (model.Tiempo_Limpieza == null)
            {
                toReturn.Add(new Tuple<string, string>("Tiempo_Limpieza", "Por favor ingrese una cantidad en minutos"));
            }
            if (model.Tiempo_Revision == null)
            {
                toReturn.Add(new Tuple<string, string>("Tiempo_Revision", "Por favor ingrese una cantidad en minutos"));
            }
            if (model.Numero_Inicio_Boleta == null)
            {
                toReturn.Add(new Tuple<string, string>("Numero_Inicio_Boleta", "Por favor ingrese número"));
            }
            if (model.Numero_Fin_Boleta == null)
            {
                toReturn.Add(new Tuple<string, string>("Numero_Fin_Boleta", "Por favor ingrese número"));
            }
            if (model.Numero_Inicio_Boleta != null && model.Numero_Fin_Boleta != null && model.Numero_Fin_Boleta < model.Numero_Inicio_Boleta)
            {
                toReturn.Add(new Tuple<string, string>("Numero_Fin_Boleta", "El número de fin no puede ser menor al de inicio"));
            }
        ...
        private List<Tuple<string, string>> GetErroresDelete(DeleteViewModel model)
        {
            ...
            if (suitesRepository.ObtenerTodo().Where(w => w.ParametroId == model.ParametroId).Count() > 0)
            {
                toReturn.Add(new Tuple<string, string>("ErrorMessage", "No se pudo borrar el parametro porque se encuentra asociado a una suite"));
            }
            return toReturn;
        }
